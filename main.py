...
# 🔑 СЕКРЕТНЫЕ КЛЮЧИ (Меняйте на свои при желании)
KEY_VIP_DRIVER = "CRAZY_START"   # Ключ для мгновенного найма водителя
KEY_VIP_ADMIN = "BIG_BOSS_777"   # Ключ для назначения администратора
